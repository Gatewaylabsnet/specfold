...
<p align="center">
  ...
  ·
  <a href="https://github.com/Gatewaylabsnet/specfold/releases/tag/v1.2.0">Download v1.2.0</a>
  ·
...
| --- | --- | --- |
| Windows x64 | Installer | [Specfold-1.2.0-x64.exe](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-x64.exe) |
| Windows x64 | Portable app | [Specfold-1.2.0-x64-portable.exe](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-x64-portable.exe) |
| macOS Apple Silicon | DMG | [Specfold-1.2.0-mac-arm64.dmg](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-mac-arm64.dmg) |
| macOS Apple Silicon | ZIP | [Specfold-1.2.0-mac-arm64.zip](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-mac-arm64.zip) |
| macOS Intel | DMG | [Specfold-1.2.0-mac-x64.dmg](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-mac-x64.dmg) |
| macOS Intel | ZIP | [Specfold-1.2.0-mac-x64.zip](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-mac-x64.zip) |
| Linux x64 | AppImage | [Specfold-1.2.0-linux-x86_64.AppImage](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-linux-x86_64.AppImage) |
| Linux x64 | Debian package | [Specfold-1.2.0-linux-amd64.deb](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/Specfold-1.2.0-linux-amd64.deb) |
| All platforms | SHA-256 checksums | [SHA256SUMS.txt](https://github.com/Gatewaylabsnet/specfold/releases/download/v1.2.0/SHA256SUMS.txt) |

Release page: [github.com/Gatewaylabsnet/specfold/releases/tag/v1.2.0](https://github.com/Gatewaylabsnet/specfold/releases/tag/v1.2.0). The previous [v1.1.1 release](https://github.com/Gatewaylabsnet/specfold/releases/tag/v1.1.1) remains available.
...
On Windows PowerShell, compare `Get-FileHash .\Specfold-1.2.0-x64.exe -Algorithm SHA256` with the matching line in `SHA256SUMS.txt`.
...
Because v1.2.0 is not notarized, macOS may require opening the app from Finder with **Open**.
...
```bash
chmod +x Specfold-1.2.0-linux-x86_64.AppImage
./Specfold-1.2.0-linux-x86_64.AppImage
```

For Debian-based distributions:

```bash
sudo dpkg -i Specfold-1.2.0-linux-amd64.deb
...
```bash
git tag -a v1.2.0 -m "Specfold v1.2.0"
...
- Auto-update is not implemented in v1.2.0.
